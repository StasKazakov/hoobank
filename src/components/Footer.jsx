...
const Footer = () => (
    ...
    ${styles.paddingY} flex-col`}>
        ...
        md:flex-row flex-col mb-8 w-full`}>
            <div className='flex-1 flex flex-col
            justify-start mr-10'>
                <img src={logo} alt="hoobank"
                className="w-[266px] h-[72px] object-contain" />
                <p className={`${styles.paragraph} mt-4
                max-w-[310px]`}>A new way to make the payments easy, 
                    reliable and secure.</p>
            </div>

            <div className='flex-[1.5] w-full flex
            ...
            md:mt-0 mt-10'>
                {footerLinks.map((footerLink) => (
                    ...
                    ss:my-0 my-4 min-w-[150px]'>
                       ...
                       leading-[27px] text-white'>{footerLink.title}</h4>
        ...
        border-t-[1px] border-t-[#3F3E45]'>
            ...
            font-normal text-center text-[18px]
            leading-[27px] text-white'>Copyright 2021 HooBank. All Rights Reserved.</p>
